            ...
            <div className="space-y-4">
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-2 bg-white rounded-lg p-3 border border-gray-200">
                  ...
                  <p className="text-sm font-medium text-gray-900 break-all">{worker?.email}</p>
                </div>
              </div>
              <div className="space-y-1">
          ...
          <div className="min-h-screen px-4 text-center">
            <div className="flex items-center justify-center min-h-screen">
              <div
                ...
                className="w-full max-w-lg bg-white rounded-xl shadow-xl p-4 sm:p-6 text-left transform transition-all mx-4"
              >
                {/* Modal Header */}
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex flex-col gap-3 pt-6 border-t">
                    <button
                      ...
                      className="w-full px-4 py-3 text-sm font-medium text-white bg-green-600 
        ...
        <div className="fixed inset-0 z-50 overflow-y-auto bg-gray-500 bg-opacity-75">
          <div className="min-h-screen px-4 text-center">
            <div className="flex items-center justify-center min-h-screen">
              <div
                onClick={(e) => e.stopPropagation()}
                className="w-full max-w-md bg-white rounded-xl shadow-xl p-6 text-left transform transition-all"
              >
